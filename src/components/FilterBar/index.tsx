    ...
    <>
      ...
      <Grid item xs={12} sm={6} md={12}>
        <Select
          ...
          type="multiple"
          value={
            sessionFilter?.type.length > 0
              ? sessionFilter?.type?.map((i) => i.toString())
              : ""
          }
          onChange={(e) => {
      ...
      <Grid item xs={12} sm={6} md={12}>
        <Select
          ...
          type="multiple"
          value={
            sessionFilter?.color?.length > 0
              ? sessionFilter?.color?.map((i) => i.toString())
              : ""
          }
          onChange={(e) => {
      ...
      <Grid item xs={12} sm={6} md={12}>
        <Select
          ...
          type="multiple"
          value={
            sessionFilter?.size?.length > 0
              ? sessionFilter?.size?.map((i) => i.toString())
              : ""
          }
          onChange={(e) => {
